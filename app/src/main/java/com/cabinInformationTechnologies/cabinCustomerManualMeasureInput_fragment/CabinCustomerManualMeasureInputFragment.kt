...
class CabinCustomerManualMeasureInputFragment : com.cabinInformationTechnologies.cabinCustomerBase.BaseFragment(),
    com.cabinInformationTechnologies.cabinCustomerManualMeasureInput_fragment.CabinCustomerManualMeasureInputContracts.View {

    var presenter: com.cabinInformationTechnologies.cabinCustomerManualMeasureInput_fragment.CabinCustomerManualMeasureInputContracts.Presenter? =
        com.cabinInformationTechnologies.cabinCustomerManualMeasureInput_fragment.CabinCustomerManualMeasureInputPresenter(
            this
        )
    ...
    override fun createTextInputBox(id: Int, name: String): View {
        ...
        editText.filters = arrayOf<InputFilter>(
            com.cabinInformationTechnologies.cabinCustomerManualMeasureInput_fragment.DecimalDigitsInputFilter(
                3,
                1
            )
        )
