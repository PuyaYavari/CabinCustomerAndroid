...
class CabinCustomerRegisterFragmentPresenter(var view: com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragmentContracts.View?) :
    com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragmentContracts.Presenter,
    com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragmentContracts.InteractorOutput {

    var interactor: com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragmentContracts.Interactor? =
        com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragmentInteractor(
            this
        )
    var router: com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragmentContracts.Router? = null
    ...
    override fun onCreate(bundle: Bundle?) {
        ...
        router =
            com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragmentRouter(
                activity
            )
