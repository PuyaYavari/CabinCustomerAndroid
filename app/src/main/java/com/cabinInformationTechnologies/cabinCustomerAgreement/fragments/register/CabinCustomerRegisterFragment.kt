...
class CabinCustomerRegisterFragment : com.cabinInformationTechnologies.cabinCustomerBase.BaseFragment(),
    com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragmentContracts.View {
    var presenter: com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragmentContracts.Presenter? =
        com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragmentPresenter(
            this
        )
    private lateinit var listener: com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragment.RegisterFragmentListener


    //region Lifecycle
    override fun onAttach(context: Context) {
        super.onAttach(context)
        if (context is com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragment.RegisterFragmentListener) {
            listener = context
        } else {
    ...
    override fun setOnContinuePressedListener(listener: com.cabinInformationTechnologies.cabinCustomerAgreement.fragments.register.CabinCustomerRegisterFragment.RegisterFragmentListener) {
