...
class CabinCustomerAddExtraditionAdapter(val view: com.cabinInformationTechnologies.cabinCustomerExtraditions.fragments.addExtradition.CabinCustomerAddExtraditionContracts.View,
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
                                    viewType: Int): com.cabinInformationTechnologies.cabinCustomerExtraditions.fragments.addExtradition.CabinCustomerAddExtraditionAdapter.ExtraditionProductViewHolder {
        // create a new view
        ...
        return com.cabinInformationTechnologies.cabinCustomerExtraditions.fragments.addExtradition.CabinCustomerAddExtraditionAdapter.ExtraditionProductViewHolder(
            currentProductView
        )
    }

    // Replace the contents of a view (invoked by the layout manager)
    override fun onBindViewHolder(holder: com.cabinInformationTechnologies.cabinCustomerExtraditions.fragments.addExtradition.CabinCustomerAddExtraditionAdapter.ExtraditionProductViewHolder, position: Int) {
