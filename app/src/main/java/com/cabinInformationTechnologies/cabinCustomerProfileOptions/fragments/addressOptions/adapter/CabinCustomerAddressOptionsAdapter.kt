...
class CabinCustomerAddressOptionsAdapter (val fragment: com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.CabinCustomerAddressOptionsContracts.View,
                                          private val myDataset: MutableList<com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.CabinCustomerAddressOptionsContracts.Addressbox>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private var recentlyDeletedItemPosition: Int? = null
    private var recentlyDeletedItem: com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.CabinCustomerAddressOptionsContracts.Addressbox? = null
    ...
    override fun onCreateViewHolder(
        ...
        when (viewType) {
            com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.AddressesListTypeID.Companion.NO_ADDRESS_TYPE -> {
                val boxView = inflater.inflate(R.layout.cabin_customer_address_options_no_address_view,
                    parent, false)
                return com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.CabinCustomerAddressOptionsAdapter.NoAddressViewHolder(
                    boxView
                )
            }
            com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.AddressesListTypeID.Companion.ADDRESS_TYPE -> {
                val boxView =
                    inflater.inflate(R.layout.cabin_customer_address_options_addressbox_view,
                        parent, false)
                return com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.CabinCustomerAddressOptionsAdapter.AddressViewHolder(
                    boxView
                )
            }
            com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.AddressesListTypeID.Companion.TAX_INVOICE_ADDRESS_TYPE -> {
                val boxView =
                    inflater.inflate(R.layout.cabin_customer_address_options_invoice_addressbox_view,
                        parent, false)
                return com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.CabinCustomerAddressOptionsAdapter.TaxInvoiceAddressViewHolder(
                    boxView
                )
            }
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (getItemViewType(position)) {
            com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.AddressesListTypeID.Companion.NO_ADDRESS_TYPE -> {
                val holder = viewHolder as com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.CabinCustomerAddressOptionsAdapter.NoAddressViewHolder
            ...
            com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.AddressesListTypeID.Companion.ADDRESS_TYPE -> {
                val holder = viewHolder as com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.CabinCustomerAddressOptionsAdapter.AddressViewHolder
            ...
            com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.AddressesListTypeID.Companion.TAX_INVOICE_ADDRESS_TYPE -> {
                val holder = viewHolder as com.cabinInformationTechnologies.cabinCustomerProfileOptions.fragments.addressOptions.adapter.CabinCustomerAddressOptionsAdapter.TaxInvoiceAddressViewHolder
                val address = myDataset[position].getAddress()
                holder.itemView.apply {
