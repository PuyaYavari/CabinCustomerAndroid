...
class CabinCustomerRegisterFragmentPresenter(var view: CabinCustomerRegisterFragmentContracts.View?) :
    CabinCustomerRegisterFragmentContracts.Presenter, CabinCustomerRegisterFragmentContracts.InteractorOutput {

    var interactor: CabinCustomerRegisterFragmentContracts.Interactor? = CabinCustomerRegisterFragmentInteractor(this)
    ...
    override fun onCreate(bundle: Bundle?) {
        ...
        router = CabinCustomerRegisterFragmentRouter(activity)
