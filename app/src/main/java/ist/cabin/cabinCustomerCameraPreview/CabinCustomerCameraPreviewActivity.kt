...
class CabinCustomerCameraPreviewActivity : BaseActivity(),
    CabinCustomerCameraPreviewContracts.View {

    var presenter: CabinCustomerCameraPreviewContracts.Presenter? = CabinCustomerCameraPreviewPresenter(this)
