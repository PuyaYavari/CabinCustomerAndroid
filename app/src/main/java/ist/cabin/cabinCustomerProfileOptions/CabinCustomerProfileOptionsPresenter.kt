...
class CabinCustomerProfileOptionsPresenter(var view: CabinCustomerProfileOptionsContracts.View?) :
    CabinCustomerProfileOptionsContracts.Presenter, CabinCustomerProfileOptionsContracts.InteractorOutput {

    var interactor: CabinCustomerProfileOptionsContracts.Interactor? = CabinCustomerProfileOptionsInteractor(this)
