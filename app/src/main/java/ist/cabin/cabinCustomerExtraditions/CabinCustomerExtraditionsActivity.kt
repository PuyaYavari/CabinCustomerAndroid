...
class CabinCustomerExtraditionsActivity : BaseActivity(),
    CabinCustomerExtraditionsContracts.View {

    var presenter: CabinCustomerExtraditionsContracts.Presenter? =
        CabinCustomerExtraditionsPresenter(this)
