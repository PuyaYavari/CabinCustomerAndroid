...
class CabinCustomerOrdersSentFragmentPresenter(var view: CabinCustomerOrdersSentFragmentContracts.View?) :
    CabinCustomerOrdersSentFragmentContracts.Presenter,
    CabinCustomerOrdersSentFragmentContracts.InteractorOutput {

    var interactor: CabinCustomerOrdersSentFragmentContracts.Interactor? =
        CabinCustomerOrdersSentFragmentInteractor(
            this
        )
    ...
    override fun onCreate(bundle: Bundle?) {
        ...
        router =
            CabinCustomerOrdersSentFragmentRouter(
                activity
            )
