...
class CabinCustomerAgreementFragment : BaseFragment(),
    CabinCustomerAgreementFragmentContracts.View {

    var presenter: CabinCustomerAgreementFragmentContracts.Presenter? =
        CabinCustomerAgreementFragmentPresenter(
            this
        )
