...
class CabinCustomerRegisterFragment : BaseFragment(),
    CabinCustomerRegisterFragmentContracts.View {
    var presenter: CabinCustomerRegisterFragmentContracts.Presenter? =
        CabinCustomerRegisterFragmentPresenter(
            this
        )
