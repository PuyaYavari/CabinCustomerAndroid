...
class CabinCustomerCameraActivity : BaseActivity(),
    CabinCustomerCameraContracts.View, SensorEventListener {
    ...
    var presenter: CabinCustomerCameraContracts.Presenter? = CabinCustomerCameraPresenter(this)
