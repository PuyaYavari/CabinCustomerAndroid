...
class CabinCustomerOrdersPresenter(var view: CabinCustomerOrdersContracts.View?) :
    CabinCustomerOrdersContracts.Presenter, CabinCustomerOrdersContracts.InteractorOutput {

    var interactor: CabinCustomerOrdersContracts.Interactor? = CabinCustomerOrdersInteractor(this)
